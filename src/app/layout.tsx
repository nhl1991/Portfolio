...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <section className="w-full min-h-full">{children}</section>
        <footer className="w-full flex items-center justify-end fixed bottom-0 gap-4 p-2">
          <Link href="https://github.com/nhl1991" className="w-12 h-12  rounded-full">
