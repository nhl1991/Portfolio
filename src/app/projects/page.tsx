...
function CirclingNavigationWrapper() {
    ...
    return (
        <div className="w-max h-screen flex overflow-hidden">
            <Navigation />
            <Description />
            <div className="w-12 h-12 rounded-full  border-2 border-white hover:border-gray-600 fixed left-5 top-72 p-1">
                <div className="w-full h-full flex items-center justify-center p-2">
                    <Link href={'/'}>
                        <svg className="w-8 hover:stroke-gray-600" data-slot="icon" fill="none" strokeWidth={1.5} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
