...
export default function ContactList() {
  return (
    <aside className="flex flex-row fixed h-max w-max bottom-5 md:bottom-30 right-8 md:right-16 gap-4 p-4">
      {/* Github - Navigate to Github */}
      <Link
        title="github"
        href="https://github.com/nhl1991"
        className="md:w-20 w-16 bg-black rounded-full p-2 hover:scale-105 duration-300 opacity-70"
      >
