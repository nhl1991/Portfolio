...
{/*             
            ...
            <li>
                <AboutArticle title="2. 리팩토링" content="여러 개인 프로젝트를 진행하면서 “더 나은 구조는 없을까?”, “가독성을 높일 수 있는 방법은 무엇일까?”를 지속적으로 고민하게 되었습니다.
            ...
            <li>
                <AboutArticle title="3. 백엔드 및 풀스택 역량 확장" content="현재는 프론트엔드 개발에 집중하고 있으나, 장기적으로는 프론트엔드와 백엔드를 모두 이해하는 풀스택 엔지니어로 성장하는 것을 목표로 하고 있습니다.
